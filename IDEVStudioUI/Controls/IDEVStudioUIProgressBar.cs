...
{
    public class IDEVStudioUIProgressBar : ProgressBar
    {
        #region PROPIEDADES
        //Fields
        //-> Appearance
        ...
        private Color foreBackColor;
        private int channelHeight;
        private int sliderHeight;
        private TextPosition showValue;
        ...
        #region METODOS
        //Constructor
        public IDEVStudioUIProgressBar()
        {
            this.channelColor = Color.LightSteelBlue;
            this.sliderColor = Color.RoyalBlue;
            this.foreBackColor = Color.RoyalBlue;
            this.channelHeight = 6;
            this.sliderHeight = 6;
            this.showValue = TextPosition.Right;
            this.symbolBefore = "";
            this.symbolAfter = "";
            this.showMaximun = false;
            this.paintedBack = false;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            if (stopPainting == false)
            {
                ...
                double sF1 = ((double)this.Value - this.Minimum);
                double sF2 = ((double)this.Maximum - this.Minimum);
                double scaleFactor = sF2 > 0 ? sF1 / sF2 : 0;
