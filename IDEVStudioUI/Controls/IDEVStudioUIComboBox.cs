...
namespace IDEVStudioUI.Controls
{
    ...
    public class IDEVStudioUIComboBox : UserControl
    {
        #region PROPIEDADES
        ...
        #region METODOS
        public IDEVStudioUIComboBox()
        {
            this.backColor = Color.WhiteSmoke;
            this.iconColor = Color.MediumSlateBlue;
            this.listBackColor = Color.FromArgb(230, 228, 245);
            this.listTextColor = Color.DimGray;
